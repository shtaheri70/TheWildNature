...
namespace TheWildNature.Persintence.Migrations
{
    ...
    [Migration("20230624173624_CreateDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.Food.FoodOfCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FoodOfCategories");
                });

            modelBuilder.Entity("TheWildNature.Domain.Entities.Food.FoodOfCategoryKitchen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FoodOfCategoryKitchen");
                });
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.User.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.User.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.User.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.User.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.User.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.Customer.Order", b =>
                {
                    ...
                    b.HasOne("TheWildNature.Domain.Entities.User.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.Food.FoodOfCategoryKitchen", b =>
                {
                    b.HasOne("TheWildNature.Domain.Entities.Food.FoodOfCategory", "FoodOfCategory")
            ...
            modelBuilder.Entity("TheWildNature.Domain.Entities.User.RolePermission", b =>
                {
                    b.HasOne("TheWildNature.Domain.Entities.User.Permission", "Permission")
                        .WithMany("RolePermission")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TheWildNature.Domain.Entities.User.Role", "Role")
                        .WithMany("RolePermission")
